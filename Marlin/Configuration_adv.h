...
#define CONTROLLERFAN_PIN 63 //Pin used for the fan to cool controller (-1 to disable)
...
#define HOMING_BUMP_DIVISOR {30, 30, 30}  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
