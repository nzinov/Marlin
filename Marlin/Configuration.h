...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 235.0        // (mm)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 97.24 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define Z_PROBE_ALLEN_KEY
  ...
  #define Z_PROBE_ALLEN_KEY_STOW_1 { 47.0, 70.9, 25.8 } // Move the probe into position
  #define Z_PROBE_ALLEN_KEY_STOW_1_FEEDRATE XY_PROBE_SPEED
  // Move the nozzle down further to push the probe into retracted position.
  #define Z_PROBE_ALLEN_KEY_STOW_2 { 47.0, 70.9, 25.8 - (Z_PROBE_ALLEN_KEY_STOW_DEPTH)}
  #define Z_PROBE_ALLEN_KEY_STOW_2_FEEDRATE (XY_PROBE_SPEED)/10
  // Raise things back up slightly so we don't bump into anything
  #define Z_PROBE_ALLEN_KEY_STOW_3 { 47.0, 70.9, 25.8 + (Z_PROBE_ALLEN_KEY_STOW_DEPTH)}
  #define Z_PROBE_ALLEN_KEY_STOW_3_FEEDRATE (XY_PROBE_SPEED)/2

  #define Z_PROBE_ALLEN_KEY_STOW_4 { 0.0, 0.0, 25.8+(Z_PROBE_ALLEN_KEY_STOW_DEPTH) }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 3.6, 22.9, -6.03 }
